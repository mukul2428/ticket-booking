      ...
      <div className="flex flex-col justify-center items-center m-10">
        ...
        <div className="w-2/5">
          ...
          <div className="mt-6 flex flex-row">
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              <span className="mx-6 text-sm text-gray-400 whitespace-nowrap">
                By becoming a member, you accept the Membership Agreement and
                its annexes.
              </span>
            </label>
          </div>
          ...
          <div className="mt-6 flex flex-row">
            ...
            <span className="mx-6 text-sm text-gray-400 whitespace-nowrap">
              I have my express informed consent and consent to the processing
              and sharing of my personal data requested during membership
            </span>
          </div>
          <button
            type="submit"
